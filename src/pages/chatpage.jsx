            ...
            <div className="page">   
                {
                    ...
                    (obj.id==id)&&obj.msgs.map((value,i,all)=>(<><div className="top"><NavLink to="/"><h4 className="larr">&larr;</h4></NavLink><h3 className="uname">{obj.name}</h3> <h3 className="uicon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                    ...
                    <div className="text" onClick={()=>{props.delete(all,i)}}>{value}</div></>))
